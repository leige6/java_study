package com.leige.consistentHashTest;
...
public class ConsistentHashTest<T> {
  ...
  public ConsistentHashTest(HashFunction hashFunction, int numberOfReplicas,
                        Collection<T> nodes) {
  ...
  public static final void main(String[] args) {
    ...
    ConsistentHashTest<String> consistentHash = new ConsistentHashTest<String>(new HashFunction(), 2, nodes);
